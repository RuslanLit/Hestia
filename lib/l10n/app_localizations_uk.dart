...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get noSessionData => 'Активних пристроїв не знайдено';
  ...
  @override
  String get logoutCurrent => 'Вийти з цього пристрою';
  ...
  String get attachmentLimits =>
      'Дозволені документи, зображення, аудіо та відео. Ліміти: документи/зображення 50 МБ, аудіо 100 МБ, відео 250 МБ. Один файл на повідомлення.';
  ...
  @override
  String get muteCall => 'Мікрофон вимкнено';

  @override
  String get unmuteCall => 'Мікрофон увімкнено';
  ...
  @override
  String get diagnosticMode => 'Режим діагностики';

  @override
  String get diagnosticModeDescription =>
      'За замовчуванням вимкнено. Без паролів, токенів або відкритого тексту повідомлень.';

  @override
  String get testMicrophone => 'Перевірити мікрофон';

  @override
  String get copyDiagnostics => 'Скопіювати діагностику';
  ...
  String get cameraMicPermissionsRequired =>
      'Потрібні дозволи на камеру й мікрофон.';

  @override
  String get cameraPreviewTimedOut =>
      'Час очікування попереднього перегляду камери вичерпано.';

  @override
  String get cameraUnavailableCheckPermissions =>
      'Камера недоступна. Перевірте дозволи камери й мікрофона.';

  @override
  String get noCameraVideoTrack => 'Відеодоріжку камери не створено.';

  @override
  String get micPermissionRequiredForCalls =>
      'Для дзвінків потрібен дозвіл на мікрофон.';

  @override
  String get cameraPermissionRequiredForVideoCalls =>
      'Для відеодзвінків потрібен дозвіл на камеру.';
