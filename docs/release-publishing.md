...
For `v4.0.3_4`, these files must exist locally:

```text
releases/hestia-4.0.3_4-android.apk
releases/hestia-4.0.3_4-web-static.zip
releases/hestia-4.0.3_4-backend.zip
releases/hestia-4.0.3_4-landing.zip
releases/4.0.3-checksums.txt
...
```bash
./scripts/publish_release.sh v4.0.3_4
```

PowerShell:

```powershell
pwsh -File scripts/publish_release.ps1 v4.0.3_4
```
...
Also download `4.0.3-checksums.txt` and compare at least one asset locally:
