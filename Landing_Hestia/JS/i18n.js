(function () {
  ...
  if (release.webClientUrl && platforms.web) {
    platforms.web.url = release.webClientUrl;
    platforms.web.fileName = release.webClientUrl;
  }
  ...
  const copy = {
    en: {
      ...
      platform: {
        android: ["Android APK", "Download Android APK", "Download APK"],
        ...
        web: ["Hestia Web", "Open Hestia Web", "Open Hestia Web"],
        server: ["Backend for self-hosting", "Download backend for self-hosting", "Download backend"],
        landing: ["Landing/site", "Download site package", "Download site ZIP"],
        checksums: ["Checksums / SHA-256", "Download checksums", "Download checksums"],
      },
      landing: {
        ...
        steps: [
          ["Download the client", "Install Hestia on Android. Other platforms are coming later."],
      ...
      downloads: {
        ...
        title: "Get Hestia",
        copy: "Hestia 1.0.0 is available for Android. Other platforms are coming later.",
        recommended: "Recommended download",
        notes: "Release notes",
        current: "Current release",
        version: "Version",
        sectionCopy: "Android APKs are hosted on hestiachat.site. Checksums are provided for verification before installing.",
        releasePage: "Source code",
        ...
        manualUpdateNote: "Manual verified APK updates are supported from inside the Android app.",
        knownIssue: "Known issue: If the caller times out before the callee answers, the callee may continue ringing and a late Accept will not connect. Decline or miss the call, then call again.",
      },
      server: {
  ...
  const overlays = {
    ru: {
      ...
      platform: { android: ["Android APK", "Скачать Android APK", "Скачать APK"], macos: ["macOS", "Скачать для macOS", "Скачать для macOS"], linux: ["Linux", "Скачать для Linux", "Скачать для Linux"], ios: ["iOS", "Сборка iOS", "Недоступно"], web: ["Hestia Web", "Открыть Hestia Web", "Открыть Hestia Web"], server: ["Backend для self-hosting", "Скачать backend для self-hosting", "Скачать backend"], landing: ["Лендинг/site", "Скачать site-пакет", "Скачать site ZIP"], checksums: ["Checksums / SHA-256", "Скачать checksums", "Скачать checksums"] },
      ...
      downloads: { eyebrow: "Релизные загрузки", title: "Скачать Hestia", copy: "Hestia 1.0.0 доступна для Android. Другие платформы появятся позже.", recommended: "Рекомендуемая загрузка", notes: "Заметки релиза", current: "Текущий релиз", version: "Версия", sectionCopy: "Android APK размещены на hestiachat.site. Checksums доступны для проверки перед установкой.", releasePage: "Исходный код", checksums: "Checksums", serverGuide: "Настройка сервера", available: "Доступные загрузки", unavailable: "Будет позже", status: "Статус", installTitle: "Безопасная установка", installSteps: ["Скачайте файл для своей платформы.", "Проверьте SHA-256 checksum.", "Установите или запустите пакет."], manualUpdateNote: "Приложение Android поддерживает ручную проверку и установку проверенных APK-обновлений.", knownIssue: "Известная проблема: если вызывающий завершит ожидание до ответа, принимающее устройство может продолжать звонить, а позднее принятие не подключит вызов. Отклоните или пропустите вызов и позвоните снова." },
    ...
    uk: {
      ...
      platform: { android: ["Android APK", "Завантажити Android APK", "Завантажити APK"], macos: ["macOS", "Завантажити для macOS", "Завантажити для macOS"], linux: ["Linux", "Завантажити для Linux", "Завантажити для Linux"], ios: ["iOS", "Збірка iOS", "Недоступно"], web: ["Hestia Web", "Відкрити Hestia Web", "Відкрити Hestia Web"], server: ["Backend для self-hosting", "Завантажити backend для self-hosting", "Завантажити backend"], landing: ["Лендинг/site", "Завантажити site-пакет", "Завантажити site ZIP"], checksums: ["Checksums / SHA-256", "Завантажити checksums", "Завантажити checksums"] },
      ...
      downloads: { eyebrow: "Релізні завантаження", title: "Завантажити Hestia", copy: "Hestia 1.0.0 доступна для Android. Інші платформи з'являться пізніше.", recommended: "Рекомендоване завантаження", notes: "Нотатки релізу", current: "Поточний реліз", version: "Версія", sectionCopy: "Android APK розміщено на hestiachat.site. Checksums доступні для перевірки перед встановленням.", releasePage: "Вихідний код", checksums: "Checksums", serverGuide: "Налаштування сервера", available: "Доступні завантаження", unavailable: "Буде пізніше", status: "Статус", installTitle: "Безпечне встановлення", installSteps: ["Завантажте файл для своєї платформи.", "Перевірте SHA-256 checksum.", "Встановіть або запустіть пакет."], manualUpdateNote: "Android-застосунок підтримує ручну перевірку й установлення перевірених APK-оновлень.", knownIssue: "Відома проблема: якщо абонент, що телефонує, припинить очікування до відповіді, пристрій одержувача може продовжувати дзвонити, а пізніше прийняття не підключить виклик. Відхиліть або пропустіть виклик і зателефонуйте знову." },
    ...
    pl: {
      ...
      platform: { android: ["Android", "Pobierz dla Androida", "Pobierz APK"], macos: ["macOS", "Pobierz dla macOS", "Pobierz dla macOS"], linux: ["Linux", "Pobierz dla Linux", "Pobierz dla Linux"], ios: ["iOS", "Build iOS", "Niedostępne"], web: ["Hestia Web", "Otwórz Hestia Web", "Otwórz Hestia Web"], server: ["Serwer", "Pobierz backend", "Pobierz backend"], landing: ["Landing/site", "Pobierz pakiet site", "Pobierz site ZIP"], checksums: ["Checksums", "Pobierz checksums", "Pobierz checksums"] },
      ...
      downloads: { eyebrow: "Pliki wydania", title: "Pobierz Hestia", copy: "Hestia 1.0.0 jest dostępna na Androida. Inne platformy pojawią się później.", recommended: "Zalecane pobranie", notes: "Notatki wydania", current: "Bieżące wydanie", version: "Wersja", sectionCopy: "Pliki APK Androida są hostowane na hestiachat.site. Checksums służą do weryfikacji przed instalacją.", releasePage: "Kod źródłowy", checksums: "Checksums", serverGuide: "Konfiguracja serwera", available: "Dostępne pliki", unavailable: "Później", status: "Status", installTitle: "Bezpieczna instalacja", installSteps: ["Pobierz plik dla swojej platformy.", "Zweryfikuj checksum SHA-256.", "Zainstaluj lub uruchom pakiet."], manualUpdateNote: "Aplikacja na Androida obsługuje ręczne, zweryfikowane aktualizacje APK.", knownIssue: "Znany problem: jeśli dzwoniący zakończy oczekiwanie przed odebraniem, telefon odbiorcy może nadal dzwonić, a późniejsze odebranie nie połączy rozmowy. Odrzuć lub pomiń połączenie i zadzwoń ponownie." },
    ...
    es: {
      ...
      platform: { android: ["Android", "Descargar para Android", "Descargar APK"], macos: ["macOS", "Descargar para macOS", "Descargar para macOS"], linux: ["Linux", "Descargar para Linux", "Descargar para Linux"], ios: ["iOS", "Build iOS", "No disponible"], web: ["Hestia Web", "Abrir Hestia Web", "Abrir Hestia Web"], server: ["Servidor", "Descargar backend", "Descargar backend"], landing: ["Landing/site", "Descargar paquete site", "Descargar site ZIP"], checksums: ["Checksums", "Descargar checksums", "Descargar checksums"] },
      ...
      downloads: { eyebrow: "Descargas de versión", title: "Obtener Hestia", copy: "Hestia 1.0.0 está disponible para Android. Las demás plataformas llegarán más adelante.", recommended: "Descarga recomendada", notes: "Notas de la versión", current: "Versión actual", version: "Versión", sectionCopy: "Los APK de Android están alojados en hestiachat.site. Usa checksums para verificar antes de instalar.", releasePage: "Código fuente", checksums: "Checksums", serverGuide: "Guía del servidor", available: "Descargas disponibles", unavailable: "Más adelante", status: "Estado", installTitle: "Instalación segura", installSteps: ["Descarga el archivo para tu plataforma.", "Verifica el checksum SHA-256.", "Instala o ejecuta el paquete."], manualUpdateNote: "La aplicación de Android admite actualizaciones APK manuales y verificadas.", knownIssue: "Problema conocido: si quien llama agota el tiempo de espera antes de que respondan, el receptor puede seguir sonando y aceptar tarde no conectará la llamada. Rechaza o deja pasar la llamada y vuelve a llamar." },
    ...
    cs: {
      ...
      platform: { android: ["Android", "Stáhnout pro Android", "Stáhnout APK"], macos: ["macOS", "Stáhnout pro macOS", "Stáhnout pro macOS"], linux: ["Linux", "Stáhnout pro Linux", "Stáhnout pro Linux"], ios: ["iOS", "Build iOS", "Nedostupné"], web: ["Hestia Web", "Otevřít Hestia Web", "Otevřít Hestia Web"], server: ["Server", "Stáhnout backend", "Stáhnout backend"], landing: ["Landing/site", "Stáhnout site balíček", "Stáhnout site ZIP"], checksums: ["Checksums", "Stáhnout checksums", "Stáhnout checksums"] },
      ...
      downloads: { eyebrow: "Stažení vydání", title: "Získat Hestia", copy: "Hestia 1.0.0 je dostupná pro Android. Další platformy přijdou později.", recommended: "Doporučené stažení", notes: "Poznámky k vydání", current: "Aktuální vydání", version: "Verze", sectionCopy: "Android APK jsou hostovány na hestiachat.site. Checksums slouží k ověření před instalací.", releasePage: "Zdrojový kód", checksums: "Checksums", serverGuide: "Nastavení serveru", available: "Dostupná stažení", unavailable: "Později", status: "Stav", installTitle: "Bezpečná instalace", installSteps: ["Stáhněte soubor pro svou platformu.", "Ověřte SHA-256 checksum.", "Nainstalujte nebo spusťte balíček."], manualUpdateNote: "Aplikace pro Android podporuje ruční ověřené aktualizace APK.", knownIssue: "Známý problém: pokud volající vyprší před přijetím hovoru, příjemci může telefon dále zvonit a pozdní přijetí hovor nespojí. Hovor odmítněte nebo zmeškejte a zavolejte znovu." },
    ...
    de: {
      ...
      platform: { android: ["Android", "Für Android herunterladen", "APK herunterladen"], macos: ["macOS", "Für macOS herunterladen", "Für macOS herunterladen"], linux: ["Linux", "Für Linux herunterladen", "Für Linux herunterladen"], ios: ["iOS", "iOS-Build", "Nicht verfügbar"], web: ["Hestia Web", "Hestia Web öffnen", "Hestia Web öffnen"], server: ["Server", "Backend herunterladen", "Backend herunterladen"], landing: ["Landing/site", "Site-Paket herunterladen", "Site ZIP herunterladen"], checksums: ["Checksums", "Checksums herunterladen", "Checksums herunterladen"] },
      ...
      downloads: { eyebrow: "Release-Downloads", title: "Hestia herunterladen", copy: "Hestia 1.0.0 ist für Android verfügbar. Weitere Plattformen folgen später.", recommended: "Empfohlener Download", notes: "Release Notes", current: "Aktuelles Release", version: "Version", sectionCopy: "Android-APKs werden auf hestiachat.site gehostet. Checksums helfen bei der Prüfung vor der Installation.", releasePage: "Quellcode", checksums: "Checksums", serverGuide: "Server-Anleitung", available: "Verfügbare Downloads", unavailable: "Kommt später", status: "Status", installTitle: "Sicher installieren", installSteps: ["Datei für deine Plattform herunterladen.", "SHA-256 Checksum prüfen.", "Paket installieren oder starten."], manualUpdateNote: "Die Android-App unterstützt manuelle, verifizierte APK-Updates.", knownIssue: "Bekanntes Problem: Wenn beim Anrufer die Wartezeit vor der Annahme abläuft, kann das Gerät des Empfängers weiter klingeln und eine späte Annahme verbindet den Anruf nicht. Lehne den Anruf ab oder verpasse ihn und rufe erneut an." },
  ...
  function pageSeo() {
    ...
    const map = {
      ...
      downloads: {
        ...
        keywords: "Hestia downloads, Android APK, Linux messenger, macOS messenger",
      },
      server: {
  ...
  function updateSeo() {
    ...
    upsertMeta('script[type="application/ld+json"][data-schema="software"]', "script", {
      ...
      textContent: JSON.stringify({
        ...
        operatingSystem: "Android, macOS, Linux, Web",
  ...
  function platformLabel(key, index) {
    const androidAbiLabels = {
      android: "Android arm64-v8a",
      androidArmv7: "Android armeabi-v7a",
      androidX64: "Android x86_64",
    };
    if (index === 0 && androidAbiLabels[key]) return androidAbiLabels[key];
    if ((key === "androidArmv7" || key === "androidX64") && index > 0) {
      return langData().platform.android[index] || copy.en.platform.android[index];
    }
  ...
  function platformDescription(key) {
    const descriptions = {
      ...
      web: {
        en: "Open the hosted Hestia web client in your browser.",
        ru: "Откройте Hestia Web в браузере.",
        uk: "Відкрийте Hestia Web у браузері.",
      ...
      checksums: {
        en: "SHA-256 hashes for verifying public downloads.",
        ru: "SHA-256 хэши для проверки публичных загрузок.",
        uk: "SHA-256 хеші для перевірки публічних завантажень.",
    ...
    const descriptionKey = key === "androidArmv7" || key === "androidX64"
      ? "android"
      : key;
    return descriptions[descriptionKey]?.[window.HestiaLang] || descriptions[descriptionKey]?.en || "";
  }
  ...
  function renderLanding() {
    ...
    document.querySelector("main").innerHTML = `
        ...
        <div class="hero-shell">
          <div class="hero-content">
            ...
            <div class="cta-row" aria-label="Recommended download">
              ...
              ${platforms.web?.available !== false && platforms.web?.url ? `<a class="button button-secondary" href="${platforms.web.url}">${escapeHtml(d.web)}</a>` : ""}
            </div>
      ...
      <section class="downloads" id="downloads" aria-labelledby="downloads-title">
        ...
        <div class="section-actions"><a class="button button-secondary" href="downloads.html">${escapeHtml(d.releaseDetails)}</a>${release.releaseNotesUrl ? `<a class="release-link" href="${release.releaseNotesUrl}">${escapeHtml(d.releaseNotes)}</a>` : ""}</div>
        <div class="download-grid">${["android", "web", "server"].map(downloadCard).join("")}</div>
      </section>
  ...
  function renderDownloads() {
    ...
    const unavailableKeys = ["web", "linux", "macos", "ios", "server"];
    document.querySelector("main").innerHTML = `
      ...
      <section class="section release-section" aria-labelledby="release-title">
        ...
        <div class="note-block"><p>${escapeHtml(d.manualUpdateNote || copy.en.downloads.manualUpdateNote)}</p><p>${escapeHtml(d.knownIssue || copy.en.downloads.knownIssue)}</p></div>
